 ...
 */
 ...
 namespace yubot_purepursuit_controller {
 ...
 void PurePursuitController::configure(
   ...
   declare_parameter_if_not_declared(node, plugin_name_ + ".wheelbase",
                                     rclcpp::ParameterValue(0.54));                             
 
   node->get_parameter(plugin_name_ + ".desired_linear_vel",
                       desired_linear_vel_);
   node->get_parameter(plugin_name_ + ".lookahead_dist", lookahead_dist_);
   node->get_parameter(plugin_name_ + ".max_vel", max_vel_);
 ...
 PLUGINLIB_EXPORT_CLASS(yubot_purepursuit_controller::PurePursuitController,
